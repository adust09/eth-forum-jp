...
- [[glossary/devnet|devnet]] — 開発用ネットワーク (devnet)
...
- [[glossary/EIP-Numbering|EIP Numbering]] — EIP番号付け
- [[glossary/EIP-712-attestation-profile|EIP-712 attestation profile]] — EIP-712アテステーションプロファイル
- [[glossary/EIPIP|EIPIP]] — EIPIP (Ethereum Improvement Proposal Implementation Process)
...
- [[glossary/Keyed-aware-mempool|Keyed-aware mempool]] — キー対応ミームプール (Keyed-aware mempool)
...
- [[glossary/Post-Quantum-Interop|Post-Quantum Interop]] — ポスト量子相互運用性 (Post-Quantum Interop)
...
- [[glossary/trusted-setup|trusted setup]] — トラステッドセットアップ
