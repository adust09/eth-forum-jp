---
title: 現在の暗号通貨が日常的なお金として機能するのを妨げる2つのパラドックス
original_title: >-
  Two paradoxes that prevent current cryptocurrencies from functioning as daily
  money
source_url: >-
  https://ethresear.ch/t/two-paradoxes-that-prevent-current-cryptocurrencies-from-functioning-as-daily-money/24710
author: mattfmccormick
date: '2026-04-22'
category: Economics
tags:
  - economics
...
> [!note] 原文
> [Two paradoxes that prevent current cryptocurrencies from functioning as daily money](https://ethresear.ch/t/two-paradoxes-that-prevent-current-cryptocurrencies-from-functioning-as-daily-money/24710) — mattfmccormick (2026-04-22)
...
1.  **分散型制御。** いかなる中央機関も、通貨供給量、金利、取引ルールを操作してはなりません。
2.  **最小化された先行者利益。** 後期採用者が、初期採用者に対して構造的に不利であってはなりません。
3.  **安定した購買力。** インフレもデフレも、時間の経過とともに保有資産の価値を侵食したり、人為的に増加させたりすべきではありません。
4.  **取引へのインセンティブ。** システムは、参加者が法定通貨に対して価格が上昇することを期待して通貨を保有するのではなく、商品やサービスを売買することを奨励しなければなりません。
...
[トピック全体を読む](https://ethresear.ch/t/two-paradoxes-that-prevent-current-cryptocurrencies-from-functioning-as-daily-money/24710)
